...
public class GameTest {
    ...
    @Test
    public void playerAScoringAfterDeuceGivesAdvantageA() {
        gameGetsToDeuce();

        game.playerAScores();

        assertEquals("Advantage A", game.score());
    }

    @Test
    public void playerBScoringAfterDeuceGivesAdvantageB() {
        gameGetsToDeuce();

        game.playerBScores();

        assertEquals("Advantage B", game.score());
    }

    @Test
    public void playerAScoringAfterAdvantageBGivesDeuce() {
        gameGetsToDeuce();
        game.playerAScores();
    ...
    @Test
    public void playerBScoringAfterAdvantageAGivesDeuce() {
        gameGetsToDeuce();
        game.playerBScores();
    ...
    @Test
    public void playerAScoringAfterAdvantageAGivesAWon() {
        gameGetsToDeuce();
        game.playerAScores();
    ...
    @Test
    public void playerBScoringAfterAdvantageBGivesBWon() {
        gameGetsToDeuce();
        game.playerBScores();
